...
int main() {
    ...
    //auto season_lengths = linspace<double>(20, 20, 1); // Tiempos de tratamiento
        ...
        for (double season_length : season_lengths) { // Bucle para recorrer los valores de season_length
            ...
            for (int traj = 0; traj < num_trajectories; ++traj) {
                ...
                while (t < t_end) {
                    ...
                    auto last_func = current_propensity_function(t-tau, season_length, t_end_treatment); // estación anterior
